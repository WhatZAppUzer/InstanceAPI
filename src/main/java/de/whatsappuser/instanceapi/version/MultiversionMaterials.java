package de.whatsappuser.instanceapi.version;
...
public enum MultiversionMaterials {
    ...
    public static boolean isNewVersion() {
        ...
        Material material = Material.matchMaterial("RED_WOOL");
        if (material != null) {
            newV = 1;
            return true;
        }
    ...
    public static MultiversionMaterials requestXMaterial(String name, byte data) {
        ...
        for (MultiversionMaterials value : MultiversionMaterials.values()) {
            if(name.toUpperCase().equalsIgnoreCase(value.m) && ((byte)value.data) == data) {
                cachedSearch.put(value.m + "," + data, value);
                return value;
            }
        }
        return null;
    ...
    public Material parseMaterial() {
        ...
        return material != null ? material : Material.matchMaterial(m);
    }
}
